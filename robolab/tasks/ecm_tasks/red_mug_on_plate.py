...
@configclass
class RedMugOnPlateTerminations:
    """Success when the red mug is resting on the clay plate and released.

    Setting either other mug on the plate aborts the episode as a truncation.
    """
...
@dataclass
class RedMugOnPlateTask(Task):
    """Clarification target: three mugs of different colours in a row; the ground truth is the red one.
    ...
    terminations = RedMugOnPlateTerminations
    instruction = {
        "default": "Put the red mug on the plate",
        "vague": "Put the cup on the plate",
        "referential": "Put that cup on the plate",
        "specific": "Put the red mug on the plate",
    }
